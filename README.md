...
## it just a ios-only version of react-native-blur. On android we replaced by View with translucent effect to simple it. Because android version of root project not good.
